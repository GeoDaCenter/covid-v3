...
if __name__ == '__main__':
    ...
    #     s3.Object('geoda-covid-atlas2', 'covid_confirmed_1p3a_state.csv').put(Body=open(os.path.join(repo_root, 'public/csv/covid_confirmed_1p3a_state.csv'), 'rb'))
    #     s3.Object('geoda-covid-atlas2', 'covid_deaths_1p3a_state.csv').put(Body=open(os.path.join(repo_root, 'public/csv/covid_deaths_1p3a_state.csv'), 'rb'))
    #     s3.Object('geoda-covid-atlas2', 'covid_confirmed_1p3a.csv').put(Body=open(os.path.join(repo_root, 'public/csv/covid_confirmed_1p3a.csv'), 'rb'))
    #     s3.Object('geoda-covid-atlas2', 'covid_deaths_1p3a.csv').put(Body=open(os.path.join(repo_root, 'public/csv/covid_deaths_1p3a.csv'), 'rb'))
