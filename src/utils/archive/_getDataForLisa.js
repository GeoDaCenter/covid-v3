...
//   const { numerator, nProperty, nIndex, denominator, dType, dIndex } =
//     dataParams;
...
//     let tempDIndex =
//       dType === 'time-series' ? tableData[0][denominator].length - 1 : dIndex;

//     // loop through, do appropriate calculation. add returned value to rtn array
//     while (n > 0) {
//       n--;
//       tempDict[tableData[n].properties.GEOID] =
//         dataFn(tableData[n][numerator], tableData[n][denominator], {
//           ...dataParams,
//           nIndex: tempNIndex,
//           dIndex: tempDIndex,
//         }) || 0;
...
//       tempDict[tableData[n].properties.GEOID] =
//         dataFn(
//           tableData[n][numerator],
//           tableData[n][denominator],
//           dataParams,
//         ) || 0;
//     }
//   }
