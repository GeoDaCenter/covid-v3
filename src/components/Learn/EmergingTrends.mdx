...
export const config = {
    ...
    title: 'Identifying Trends Over Time :: US Covid Atlas Learn',
    description: 'Identifying Trends Over Time',
}
...
<SelfContainedVideoModal
    ...
    videoUrl="https://www.youtube.com/embed/qCcRrSCVnVI"
    title="Identifying Trends Over Time"
    />
...
Using the arrows icon in the bottom right hand corner <Icon symbol="resize" />, expand the **_Line Chart_** window for a better view of the data. Click on a county to visualize county-specific COVID trends or leave counties unselected for a national overview of historical case data.
