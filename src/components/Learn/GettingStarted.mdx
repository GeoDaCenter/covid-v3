...
<Grid container spacing={8}>
    ...
    <img src="/img/learn/Overview101/timeslider.png" width="10%"  alt="descriptive text" />

    To view how data in this county has changed over time, you may want to move the Time Slider by dragging your cursor along the white line or pressing the play button , or by clicking on the date and Calendar Icon at the top to select a date. 

    <Icon symbol="play" /> The play button starts an animation of data changing over time.
