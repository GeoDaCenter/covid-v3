          ...
          <ReportContainer expanded={expanded}>
            ...
            {sidebarData.hasOwnProperty("cases") &&
              sidebarData.hasOwnProperty("deaths") && (
                <ReportSection>
                  ...
                  <h3>
                    {sidebarData.cases7d?.toFixed(2).toLocaleString("en")}
                  </h3>
                  ...
                  <h3>
                    {sidebarData.deaths7d?.toFixed(2).toLocaleString("en")}
                  </h3>
            ...
            {sidebarData.hasOwnProperty("testing") && (
              <ReportSection>
                ...
                <p>
                  7-Day Tests Performed <br className="bigOnly" /> per 100k
                  People
                </p>
                <div className="numberChartContainer">
            ...
            {sidebarData.hasOwnProperty("PovChldPrc") && (
              <ReportSection>
                ...
                <h3>
                  ${sidebarData.MedianHouseholdIncome.toLocaleString("en")}
                </h3>
                <p>Food insecurity</p>
                <Tooltip id="FdInsPrc" />
